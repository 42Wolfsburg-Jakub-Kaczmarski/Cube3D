...
SRCs = main.c Rendering/tools.c Movement/keys.c Movement/arrows.c Movement/key_hook.c get_next_line.c get_next_line_utils.c keys.c \
...
Cube3d:
	gcc -g $(SRCs) libmlx.dylib -framework Cocoa -framework OpenGL -framework IOKit libft.a -o Cube3d
