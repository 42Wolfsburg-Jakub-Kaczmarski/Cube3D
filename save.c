...
/*   Updated: 2022/07/02 18:08:49 by kmilchev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int draw_rays(t_mlx *mlx_info)
{
	...
	for (r = 0;r < 60; r++)
	{
		...
		while(dof < 8)
		{
			...
			{
				printf("HIT HORIZONTALLY___________________________\n");
				dof = 8;
			}
			else
			{
		...
		while(dof < 8)
		{
			...
			if ((mx >= 0 && mx <= (mlx_info->map_width - 1)) && (my >= 0 &&  my <= (mlx_info->map_height - 1)) && mlx_info->map[my][mx] == '1')
			{
				printf("HIT VERTICALLY___________________________\n");
				dof = 8;
			}
			else
			{
...
if ((mx >= 0 && mx <= (mlx_info->map_width - 1)) && (my >= 0 &&  my <= (mlx_info->map_height - 1)))
			{
				printf("MX: %d\n", mx);
				printf("MY: %d\n", my);
				if (mlx_info->map[my][mx] == '1')
				{
					printf("HIT HOTIZONTALLY___________________");
					dof = 8;
				}
			}